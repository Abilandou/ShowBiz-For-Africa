 ...
 */
class Eblog_Lite_List_Layout_Section extends WP_Widget {

	/* Register Widget with WordPress*/
	function __construct() {
		parent::__construct(
			'eblog_lite_blog_list_layout_section', // Base ID
			esc_html__( 'Homepage: List Layout', 'eblog-lite' ), //Widget Name
			array( 'description' => esc_html__( 'Display the post slider.', 'eblog-lite' ), ) // Args
		);
	}
	/**
     * Widget Form Section
	...
	public function widget( $args, $instance ) {
        ...
        $enable_header_title_sec = $instance[ 'enable_header_title_sec' ] ? true : false;
        // Latest Posts
	...
	?>
        <div id="homepage-list-layout" class="homepage-list">
...
function eblog_lite_list_layout_section_config() {
    register_widget( 'Eblog_Lite_List_Layout_Section' );
}
add_action( 'widgets_init', 'eblog_lite_list_layout_section_config' );